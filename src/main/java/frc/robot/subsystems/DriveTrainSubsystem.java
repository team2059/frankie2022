...
public class DriveTrainSubsystem extends SubsystemBase {
  ...
  CANSparkMax leftFrontCANSparkMax = new CANSparkMax(2, CANSparkMaxLowLevel.MotorType.kBrushless);
  CANSparkMax leftBackCANSparkMax = new CANSparkMax(1, CANSparkMaxLowLevel.MotorType.kBrushless);
  CANSparkMax rightFrontCANSparkMax = new CANSparkMax(3, CANSparkMaxLowLevel.MotorType.kBrushless);
  CANSparkMax rightBackCANSparkMax = new CANSparkMax(4, CANSparkMaxLowLevel.MotorType.kBrushless);
